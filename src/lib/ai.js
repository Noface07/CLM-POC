...
export const MOCK_OBLIGATIONS = [
  // Deadlines that change the contract by themselves. These are the ones a scheduler
  // exists for: nobody acts, and the position moves anyway on the day.
  { id: "OBL-4.1", clause: "4.1", name: "Serve notice of non-renewal, or the term rolls for another 12 months", responsible: "Either Party", notify: "The other party", frequency: "One-time (before each renewal)", due: "90 days before the end of the current term", evidence: "Written notice, served and acknowledged", consequence: "Miss it and the Agreement renews automatically for a further twelve (12) months at the current Charges.", confidence: "High",
    lapse: { effect: "The Agreement renewed for a further 12 months. The window to prevent it has closed.", irreversible: true } },
  { id: "OBL-11.2", clause: "11.1", name: "Replace the public liability certificate before it expires", responsible: "Supplier", notify: "Contract Manager", frequency: "Annually", due: "On the certificate expiry date", evidence: "Certificate of currency for the following period", consequence: "On expiry the Supplier is working uninsured and the Client carries the exposure.", confidence: "High",
    lapse: { effect: "Cover lapsed. The Supplier is working uninsured from this date until a replacement certificate is filed.", irreversible: false } },
  { id: "OBL-9.2", clause: "9.2", name: "Cure a notified material breach within the cure period", responsible: "Supplier", notify: "Client", frequency: "One-time (per notice)", due: "30 days from service of a breach notice", evidence: "Evidence the breach is remedied", consequence: "If the breach is not cured in the window the Client's right to terminate for cause crystallises.", confidence: "High",
    lapse: { effect: "The cure period expired without remedy. The right to terminate for cause is now exercisable.", irreversible: false } },
  { id: "OBL-12.2", clause: "12.1", name: "Delete or return personal data after termination", responsible: "Supplier", notify: "Client (controller)", frequency: "One-time (on termination)", due: "30 days after the termination date", evidence: "Written confirmation of deletion or return", consequence: "Retention beyond the window is processing without a lawful basis, which is the Client's regulatory exposure.", confidence: "High",
    lapse: { effect: "The deletion window closed. Any data still held is now processed without a lawful basis.", irreversible: true } },
